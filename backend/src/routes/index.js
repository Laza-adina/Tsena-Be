...
router.post('/upload/product', authVendeur, upload.single('image'), upload_ctrl.uploadProductImage);
router.post('/upload/profile', authVendeur, upload.single('image'), upload_ctrl.uploadProfileImage);

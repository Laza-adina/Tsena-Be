  ...
  return (
    <div style={{ minHeight: '100vh', background: C.beige, fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: '480px', margin: '0 auto', padding: '48px 24px', textAlign: 'center' }}>
        ...
        <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '30px', fontWeight: '700', color: C.dark, margin: '0 0 8px', letterSpacing: '-0.5px' }}>
          QR Code
        </h1>
        <p style={{ fontSize: '13px', color: C.muted, margin: '0 0 36px', fontWeight: '300', lineHeight: '1.7' }}>
          Imprimez ce QR code et collez-le sur votre stand ou carte de visite.
        </p>

        {/* QR Card */}
        <div style={{ background: C.cream, border: `1px solid ${C.light}`, borderRadius: '20px', padding: '36px', display: 'inline-block', marginBottom: '20px' }}>
          {qrCode && (
        ...
        {/* URL */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: C.cream, border: `1px solid ${C.light}`, borderRadius: '10px', padding: '10px 14px', marginBottom: '24px', cursor: 'pointer' }} onClick={handleCopy}>
          <p style={{ fontSize: '13px', color: C.muted, margin: 0, fontWeight: '300', flex: 1, textAlign: 'left', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {shopUrl}
          </p>
          <span style={{ fontSize: '11px', fontWeight: '600', color: copied ? C.caramel : C.muted, whiteSpace: 'nowrap', transition: 'color 0.2s' }}>
            {copied ? 'Copié ✓' : 'Copier'}
          </span>
        </div>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'center' }}>
          <button
            ...
            style={{ padding: '12px 24px', background: C.dark, color: C.cream, border: 'none', borderRadius: '8px', fontSize: '13px', fontWeight: '600', cursor: 'pointer' }}
          >
            Télécharger en PNG
          </button>
          <button
            ...
            onClick={handleCopy}
            style={{ padding: '12px 24px', background: C.light, color: C.dark, border: 'none', borderRadius: '8px', fontSize: '13px', fontWeight: '500', cursor: 'pointer' }}
          >

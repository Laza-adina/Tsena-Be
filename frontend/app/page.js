  ...
  return (
    ...
    >
      ...
      <section
        ...
        style={{ background: C.cream, textAlign: "center" }}
      >
        <div style={{ maxWidth: "700px", margin: "0 auto" }}>
          ...
          <h1
            ...
            style={{ ...heroItem(120), color: C.dark, margin: "0 0 24px" }}
          >
            Votre boutique en ligne{" "}
            <em style={{ color: C.caramel, fontStyle: "italic" }}>
              en 5 minutes
            </em>
          </h1>
          <p
          ...
          >
            Créez votre mini-boutique, partagez vos produits sur Facebook et
            ...
            {[
              {
                ...
                desc: "Inscrivez-vous avec votre e-mail, choisissez un nom de boutique et ajoutez votre numéro WhatsApp.",
              },
              {
                num: "02",
                title: "Ajoutez vos produits",
                desc: "Importez les photos de vos articles, renseignez les prix et une référence. Votre catalogue est prêt.",
              },
              {
                num: "03",
                title: "Partagez votre lien",
                desc: "Copiez votre lien unique et partagez-le sur Facebook, WhatsApp ou imprimez votre QR Code.",
              },
            ].map((step, i) => (
      ...
      >
        <div style={{ maxWidth: "880px", margin: "0 auto" }}>
          ...
          <FadeIn delay={100}>
            ...
            >
              Paiement via MVola, Orange Money ou Airtel Money. Activation
              manuelle sous 24h.
            </p>
          </FadeIn>
        </div>
        ...
        <div style={{ maxWidth: "880px", margin: "0 auto" }}>
          <div className="footer-grid" style={{ marginBottom: "48px" }}>
            <div>
              ...
              >
                La plateforme de mini-boutiques pour les vendeurs malgaches.
                Simple, rapide, adaptée à votre quotidien.
              </p>
              <a
                href="https://wa.me/261345159568"
                rel="noreferrer"
                target="_blank"
                style={{
                  fontSize: "13px",
                  ...
                  textDecoration: "none",
                  fontWeight: "500",
                  borderBottom: `1px solid ${C.caramel}60`,
                  paddingBottom: "1px",
                }}
              >

...
const C = {
  ...
  light:   '#EBEBEB',   // gris très clair — bordures
  cream:   '#FFFFFF',   // blanc pur — fond dominant
  beige:   '#F5F5F5',   // blanc cassé — carte mensuelle
  caramel: '#3C6E71',   // bleu-pétrole — accents
  dark:    '#353535',   // charbon — texte principal
  text:    '#353535',
  muted:   '#284B63',   // bleu marine — textes secondaires

  // alias footer (texte lisible sur fond sombre)
  footerText:   '#D9D9D9',
  footerBorder: '#484848',
  footerMuted:  '#888888',
};
...
export default function LandingPage() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: C.cream, color: C.text, minHeight: '100vh' }}>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
          ...
          .footer-outer { padding: 48px 20px 32px !important; }
        }
      `}</style>
      ...
      {/* COMMENT ÇA MARCHE — fond gris clair pour alterner */}
            ...
            {[
              ...
              <FadeIn key={step.num} delay={i * 100}>
                <div className="plan-card" style={{ background: C.main, padding: '40px 30px', height: '100%' }}>
                  {/* numéro : bleu-pétrole sur gris clair → contraste correct */}
                  <p className="step-num" style={{ fontSize: '56px', fontWeight: '600', color: C.caramel, margin: '0 0 20px', lineHeight: 1 }}>
                    {step.num}
                  </p>
      ...
      <section id="tarifs" className="section-pad" style={{ background: C.cream }}>
        <div style={{ maxWidth: '880px', margin: '0 auto' }}>
          ...
          <div className="plans-grid">
            ...
            <FadeIn delay={200}>
              {/* carte fond sombre : tous les textes en C.cream ou C.main */}
      ...
      {/* FOOTER */}
      <footer className="footer-outer" style={{ background: C.dark, padding: '64px 40px 40px' }}>
        <div style={{ maxWidth: '880px', margin: '0 auto' }}>
          <div className="footer-grid" style={{ marginBottom: '48px' }}>
            ...
            <div>
              ...
              <a href="https://wa.me/261322875163" rel="noreferrer" target="_blank" style={{ fontSize: '13px', color: C.caramel, textDecoration: 'none', fontWeight: '500', borderBottom: `1px solid ${C.caramel}60`, paddingBottom: '1px' }}>
                Nous contacter sur WhatsApp
              </a>
            </div>

            <div>
              <p style={{ fontSize: '10px', fontWeight: '600', color: C.footerText, margin: '0 0 22px', textTransform: 'uppercase', letterSpacing: '2px' }}>Plateforme</p>
              {[
            ...
            <div>
              ...
              {[
                { label: 'WhatsApp', href: 'https://wa.me/261322875163' },
                { label: 'Facebook', href: '#' },
              ].map(link => (
          ...
          <div style={{ borderTop: `1px solid ${C.footerBorder}`, paddingTop: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
            <p style={{ fontSize: '12px', color: C.footerMuted, margin: 0, fontWeight: '300' }}>powered by keyros.</p>
            <p style={{ fontSize: '12px', color: C.footerMuted, margin: 0, fontWeight: '300' }}>Madagascar</p>
          </div>
        </div>
      </footer>
